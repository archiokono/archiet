...
export default function CodeGenerationServiceCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/code_generation_services", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["code_generation_service"] })
      toast.success("CodeGenerationService created")
      router.push(`/code_generation_service/${data.id}`)
    },
    onError: (err: unknown) => {
