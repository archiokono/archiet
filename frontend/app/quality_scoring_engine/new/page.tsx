...
export default function QualityScoringEngineCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/quality_scoring_engines", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["quality_scoring_engine"] })
      toast.success("QualityScoringEngine created")
      router.push(`/quality_scoring_engine/${data.id}`)
    },
    onError: (err: unknown) => {
