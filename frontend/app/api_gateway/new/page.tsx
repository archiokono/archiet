...
export default function ApiGatewayCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/api_gateways", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["api_gateway"] })
      toast.success("ApiGateway created")
      router.push(`/api_gateway/${data.id}`)
    },
    onError: (err: unknown) => {
