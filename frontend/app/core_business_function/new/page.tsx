...
export default function CoreBusinessFunctionCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/core_business_functions", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["core_business_function"] })
      toast.success("CoreBusinessFunction created")
      router.push(`/core_business_function/${data.id}`)
    },
    onError: (err: unknown) => {
