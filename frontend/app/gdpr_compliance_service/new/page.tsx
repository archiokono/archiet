...
export default function GdprComplianceServiceCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/gdpr_compliance_services", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["gdpr_compliance_service"] })
      toast.success("GdprComplianceService created")
      router.push(`/gdpr_compliance_service/${data.id}`)
    },
    onError: (err: unknown) => {
