...
export default function AnalyticsDataStoreCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/analytics_data_stores", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["analytics_data_store"] })
      toast.success("AnalyticsDataStore created")
      router.push(`/analytics_data_store/${data.id}`)
    },
    onError: (err: unknown) => {
