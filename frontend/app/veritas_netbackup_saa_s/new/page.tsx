...
export default function VeritasNetbackupSaaSCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/veritas_netbackup_saa_s", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["veritas_netbackup_saa_s"] })
      toast.success("VeritasNetbackupSaaS created")
      router.push(`/veritas_netbackup_saa_s/${data.id}`)
    },
    onError: (err: unknown) => {
