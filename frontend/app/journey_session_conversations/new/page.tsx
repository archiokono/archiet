...
export default function JourneySessionConversationsCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/journey_session_conversations", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["journey_session_conversations"] })
      toast.success("JourneySessionConversations created")
      router.push(`/journey_session_conversations/${data.id}`)
    },
    onError: (err: unknown) => {
