...
export default function HealthMonitoringCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/health_monitorings", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["health_monitoring"] })
      toast.success("HealthMonitoring created")
      router.push(`/health_monitoring/${data.id}`)
    },
    onError: (err: unknown) => {
