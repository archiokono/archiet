...
export default function BlueprintPublicViewerCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/blueprint_public_viewers", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["blueprint_public_viewer"] })
      toast.success("BlueprintPublicViewer created")
      router.push(`/blueprint_public_viewer/${data.id}`)
    },
    onError: (err: unknown) => {
