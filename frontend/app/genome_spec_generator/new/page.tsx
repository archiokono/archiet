...
export default function GenomeSpecGeneratorCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/genome_spec_generators", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["genome_spec_generator"] })
      toast.success("GenomeSpecGenerator created")
      router.push(`/genome_spec_generator/${data.id}`)
    },
    onError: (err: unknown) => {
