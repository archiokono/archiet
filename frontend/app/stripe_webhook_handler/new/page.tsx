...
export default function StripeWebhookHandlerCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/stripe_webhook_handlers", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["stripe_webhook_handler"] })
      toast.success("StripeWebhookHandler created")
      router.push(`/stripe_webhook_handler/${data.id}`)
    },
    onError: (err: unknown) => {
