...
export default function AnalyticsEngineCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/analytics_engines", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["analytics_engine"] })
      toast.success("AnalyticsEngine created")
      router.push(`/analytics_engine/${data.id}`)
    },
    onError: (err: unknown) => {
