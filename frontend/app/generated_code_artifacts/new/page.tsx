...
export default function GeneratedCodeArtifactsCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/generated_code_artifacts", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["generated_code_artifacts"] })
      toast.success("GeneratedCodeArtifacts created")
      router.push(`/generated_code_artifacts/${data.id}`)
    },
    onError: (err: unknown) => {
