...
export default function BusinessLogicLayerCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/business_logic_layers", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["business_logic_layer"] })
      toast.success("BusinessLogicLayer created")
      router.push(`/business_logic_layer/${data.id}`)
    },
    onError: (err: unknown) => {
