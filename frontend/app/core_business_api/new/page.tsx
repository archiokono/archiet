...
export default function CoreBusinessApiCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/core_business_apis", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["core_business_api"] })
      toast.success("CoreBusinessApi created")
      router.push(`/core_business_api/${data.id}`)
    },
    onError: (err: unknown) => {
