...
export default function GitHubIntegrationServiceCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/git_hub_integration_services", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["git_hub_integration_service"] })
      toast.success("GitHubIntegrationService created")
      router.push(`/git_hub_integration_service/${data.id}`)
    },
    onError: (err: unknown) => {
