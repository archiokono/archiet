...
export default function GcpCohesityForSystemsBackupCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/gcp_cohesity_for_systems_backups", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["gcp_cohesity_for_systems_backup"] })
      toast.success("GcpCohesityForSystemsBackup created")
      router.push(`/gcp_cohesity_for_systems_backup/${data.id}`)
    },
    onError: (err: unknown) => {
