...
export default function CicdToolchainCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/cicd_toolchains", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["cicd_toolchain"] })
      toast.success("CicdToolchain created")
      router.push(`/cicd_toolchain/${data.id}`)
    },
    onError: (err: unknown) => {
