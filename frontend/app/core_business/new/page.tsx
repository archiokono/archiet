...
export default function CoreBusinessCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/core_businesses", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["core_business"] })
      toast.success("CoreBusiness created")
      router.push(`/core_business/${data.id}`)
    },
    onError: (err: unknown) => {
