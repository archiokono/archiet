...
export default function BlueprintJourneyInterfaceCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/blueprint_journey_interfaces", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["blueprint_journey_interface"] })
      toast.success("BlueprintJourneyInterface created")
      router.push(`/blueprint_journey_interface/${data.id}`)
    },
    onError: (err: unknown) => {
