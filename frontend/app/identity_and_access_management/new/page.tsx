...
export default function IdentityAndAccessManagementCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/identity_and_access_managements", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["identity_and_access_management"] })
      toast.success("IdentityAndAccessManagement created")
      router.push(`/identity_and_access_management/${data.id}`)
    },
    onError: (err: unknown) => {
