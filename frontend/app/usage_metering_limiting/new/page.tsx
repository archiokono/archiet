...
export default function UsageMeteringLimitingCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/usage_metering_limitings", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["usage_metering_limiting"] })
      toast.success("UsageMeteringLimiting created")
      router.push(`/usage_metering_limiting/${data.id}`)
    },
    onError: (err: unknown) => {
