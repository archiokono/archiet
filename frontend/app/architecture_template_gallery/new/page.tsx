...
export default function ArchitectureTemplateGalleryCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/architecture_template_galleries", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["architecture_template_gallery"] })
      toast.success("ArchitectureTemplateGallery created")
      router.push(`/architecture_template_gallery/${data.id}`)
    },
    onError: (err: unknown) => {
