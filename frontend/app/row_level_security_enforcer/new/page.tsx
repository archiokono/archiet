...
export default function RowLevelSecurityEnforcerCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/row_level_security_enforcers", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["row_level_security_enforcer"] })
      toast.success("RowLevelSecurityEnforcer created")
      router.push(`/row_level_security_enforcer/${data.id}`)
    },
    onError: (err: unknown) => {
