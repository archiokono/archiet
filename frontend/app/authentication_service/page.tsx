...
export default function AuthenticationServiceListPage() {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ["authentication_service", debouncedSearch, sortField, sortDir, page],
    queryFn: () => api.get<{ items: AuthenticationService[]; total: number } | AuthenticationService[]>("/api/authentication_services", {
  ...
  const items: AuthenticationService[] = Array.isArray(data) ? data : ((data as { items: AuthenticationService[] } | undefined)?.items ?? [])
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">AuthenticationServices</h1>
          <p className="text-sm text-muted-foreground">
            Manage authenticationservice records
          </p>
        </div>
      ...
      <div className="flex items-center gap-4 flex-wrap">
        <div className="relative flex-1 max-w-sm">
          ...
          <Input
            placeholder="Search authenticationservices..."
            value={search}
        ...
        <CardContent className="p-0">
          {isLoading ? (
            ...
            <div className="p-12 text-center">
              ...
              <h3 className="text-sm font-medium">No authenticationservices yet</h3>
              <p className="mt-1 text-xs text-muted-foreground">Create your first authenticationservice to get started.</p>
              <Link href="/authentication_service/new">
              ...
              <TableBody>
                {items.map((item) => (
                  <TableRow
                    ...
                    onClick={() => router.push(`/authentication_service/${item.id}`)}
                  >
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem asChild>
                            <Link href={`/authentication_service/${item.id}`}>View details</Link>
                          </DropdownMenuItem>
                          <DropdownMenuItem asChild>
                            <Link href={`/authentication_service/${item.id}/edit`}>Edit</Link>
                          </DropdownMenuItem>
                        </DropdownMenuContent>
                      </DropdownMenu>
                    </TableCell>
