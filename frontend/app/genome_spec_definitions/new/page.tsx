...
export default function GenomeSpecDefinitionsCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/genome_spec_definitions", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["genome_spec_definitions"] })
      toast.success("GenomeSpecDefinitions created")
      router.push(`/genome_spec_definitions/${data.id}`)
    },
    onError: (err: unknown) => {
