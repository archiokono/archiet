...
export default function FrontendApplicationCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/frontend_applications", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["frontend_application"] })
      toast.success("FrontendApplication created")
      router.push(`/frontend_application/${data.id}`)
    },
    onError: (err: unknown) => {
