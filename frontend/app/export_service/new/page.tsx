...
export default function ExportServiceCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/export_services", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["export_service"] })
      toast.success("ExportService created")
      router.push(`/export_service/${data.id}`)
    },
    onError: (err: unknown) => {
