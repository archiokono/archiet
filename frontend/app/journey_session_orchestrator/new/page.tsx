...
export default function JourneySessionOrchestratorCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/journey_session_orchestrators", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["journey_session_orchestrator"] })
      toast.success("JourneySessionOrchestrator created")
      router.push(`/journey_session_orchestrator/${data.id}`)
    },
    onError: (err: unknown) => {
