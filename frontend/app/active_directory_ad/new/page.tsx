...
export default function ActiveDirectoryAdCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/active_directory_ads", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["active_directory_ad"] })
      toast.success("ActiveDirectoryAd created")
      router.push(`/active_directory_ad/${data.id}`)
    },
    onError: (err: unknown) => {
