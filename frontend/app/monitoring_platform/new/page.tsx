...
export default function MonitoringPlatformCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/monitoring_platforms", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["monitoring_platform"] })
      toast.success("MonitoringPlatform created")
      router.push(`/monitoring_platform/${data.id}`)
    },
    onError: (err: unknown) => {
