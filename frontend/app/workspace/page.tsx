...
export default function WorkspaceListPage() {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ["workspace", debouncedSearch, sortField, sortDir, page],
    queryFn: () => api.get<{ items: Workspace[]; total: number } | Workspace[]>("/api/workspaces", {
  ...
  const items: Workspace[] = Array.isArray(data) ? data : ((data as { items: Workspace[] } | undefined)?.items ?? [])
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem asChild>
                            <Link href={`/workspace/${item.id}`}>View details</Link>
                          </DropdownMenuItem>
                          <DropdownMenuItem asChild>
                            <Link href={`/workspace/${item.id}/edit`}>Edit</Link>
                          </DropdownMenuItem>
                        </DropdownMenuContent>
                      </DropdownMenu>
                    </TableCell>
