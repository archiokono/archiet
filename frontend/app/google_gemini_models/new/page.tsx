...
export default function GoogleGeminiModelsCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/google_gemini_models", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["google_gemini_models"] })
      toast.success("GoogleGeminiModels created")
      router.push(`/google_gemini_models/${data.id}`)
    },
    onError: (err: unknown) => {
