...
export default function AiArchitectureEngineCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/ai_architecture_engines", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["ai_architecture_engine"] })
      toast.success("AiArchitectureEngine created")
      router.push(`/ai_architecture_engine/${data.id}`)
    },
    onError: (err: unknown) => {
