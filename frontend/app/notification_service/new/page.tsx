...
export default function NotificationServiceCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/notification_services", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["notification_service"] })
      toast.success("NotificationService created")
      router.push(`/notification_service/${data.id}`)
    },
    onError: (err: unknown) => {
