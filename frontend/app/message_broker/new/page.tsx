...
export default function MessageBrokerCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/message_brokers", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["message_broker"] })
      toast.success("MessageBroker created")
      router.push(`/message_broker/${data.id}`)
    },
    onError: (err: unknown) => {
