...
export default function SmtpRelayGcpCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (values: FormValues) => api.post("/api/smtp_relay_gcps", values),
    onSuccess: (data: any) => {
      queryClient.invalidateQueries({ queryKey: ["smtp_relay_gcp"] })
      toast.success("SmtpRelayGcp created")
      router.push(`/smtp_relay_gcp/${data.id}`)
    },
    onError: (err: unknown) => {
